module.exports = {
  siteMetadata: {
    title: '채플린헤어',
    description: '채플린헤어, 가맹안내, 채플린헤어 공식 홈페이지, 미용실 프랜차이즈, 지점소개',
    ...
    socialLinks: {
      ...
      youtube: 'https://www.youtube.com/channel/UCsMa9_c-dbnRYOLG1Maa2og?view_as=subscriber',
  ...
  plugins: [
    ...
    `gatsby-plugin-styled-components`,
    {
      ...
      options: {
        host: 'http://www.chaplinhair.com',
        sitemap: 'http://www.chaplinhair.com/sitemap.xml',
        policy: [{
          userAgent: '*',
          allow: '/$',
          disallow: '/',
